...
10. The final setup step is to start the server.
   ...
   If you are using macOS Monterey, port 5000 may not be available. If this is the case, you'll need to start the app on a different port with this slightly different command. 
   ```bash
